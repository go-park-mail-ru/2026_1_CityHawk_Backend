...
const (
	AuthService_Register_FullMethodName            = "/cityhawk.auth.v1.AuthService/Register"
	AuthService_Login_FullMethodName               = "/cityhawk.auth.v1.AuthService/Login"
	AuthService_OAuthLogin_FullMethodName          = "/cityhawk.auth.v1.AuthService/OAuthLogin"
...
type AuthServiceClient interface {
	...
	OAuthLogin(ctx context.Context, in *OAuthLoginRequest, opts ...grpc.CallOption) (*SessionResponse, error)
...
func (c *authServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*SessionResponse, error) {
...
func (c *authServiceClient) OAuthLogin(ctx context.Context, in *OAuthLoginRequest, opts ...grpc.CallOption) (*SessionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SessionResponse)
...
func (c *authServiceClient) Refresh(ctx context.Context, in *RefreshRequest, opts ...grpc.CallOption) (*SessionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SessionResponse)
...
func (c *authServiceClient) Logout(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*v1.BoolResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServiceServer interface {
	...
	OAuthLogin(context.Context, *OAuthLoginRequest) (*SessionResponse, error)
...
func (UnimplementedAuthServiceServer) Register(context.Context, *RegisterRequest) (*SessionResponse, error) {
...
func (UnimplementedAuthServiceServer) OAuthLogin(context.Context, *OAuthLoginRequest) (*SessionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method OAuthLogin not implemented")
}
func (UnimplementedAuthServiceServer) Refresh(context.Context, *RefreshRequest) (*SessionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Refresh not implemented")
}
func (UnimplementedAuthServiceServer) Logout(context.Context, *LogoutRequest) (*v1.BoolResponse, error) {
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cityhawk.auth.v1.AuthService",
	...
	Metadata: "cityhawk/auth/v1/auth.proto",
}
